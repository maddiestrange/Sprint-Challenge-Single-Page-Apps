...
> Answer: Client-side allows you to control your site URL & content with Javascript, avoiding having to wait for a server to respond with content. (more efficient)
- [ ] What does AJAX stand for?
> Answer: asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Components controlled by state.
